 ...
 * Connect to the TCP Port 9003 (default port of Heartbeat Client Support)
...
{
    std::cout << "------------------- Client test for unsecured (no-TLS) SystemState Heartbeat Client Support ---------------------" << std::endl;
    try
    {
        //Create the client. It will connect to the server while construction
        //initializing all fields.
        BinaryInterfaceClient client(hostName, 9003);
