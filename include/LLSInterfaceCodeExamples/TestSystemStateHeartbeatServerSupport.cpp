 ...
 * Connect to the TCP Port 9001 (default port of Heartbeat Server Support)
...
{
    std::cout << "------------------- Client test for unsecured (no-TLS) SystemState Heartbeat Server Support ---------------------" << std::endl;
    try
    {
        //Create the client. It will connect to the server while construction
        //initializing all fields.
        BinaryInterfaceClient client(hostName, 9001);
