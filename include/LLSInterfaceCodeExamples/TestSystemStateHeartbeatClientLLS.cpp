 ...
 * Connect to the TCP Port 9002 (default port of Heartbeat Client)
...
{
    std::cout << "------------------- Client test for unsecured (no-TLS) SystemState Heartbeat Client ---------------------" << std::endl;
    try
    {
        //Create the client. It will connect to the server while construction
        //initializing all fields.
        BinaryInterfaceClient client(hostName, 9002);
