...
#ifndef BINARYINTERFACEMAPVISUALIZATIONSTRUCTS_H
#define BINARYINTERFACEMAPVISUALIZATIONSTRUCTS_H
...
/*
 * structure containing the exact message from the ClientMapVisualization Interface
 * Information to visualize the current map building process.
 */
struct MapVisualizationMessage
{
    double timestamp{0.};
...
#endif /* BINARYINTERFACEMAPVISUALIZATIONSTRUCTS_H */
